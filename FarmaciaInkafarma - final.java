...
public class FarmaciaInkafarma {
    ...
    static String[] emailsRegistrados = new String[1];
    static String[] clavesRegistradas = new String[1];
    ...
    public static boolean iniciarSesion(int intentosRestantes) {
        ...
        if (!emailValido) {
            ...
            for (int i = 0; i < totalUsuarios; i++) {
                if (emailsRegistrados[i].equals(email) && clavesRegistradas[i].equals(clave)) {
    ...
    public static void registrarUsuario() {
        ...
        emailsRegistrados[totalUsuarios] = emailNuevo;
        clavesRegistradas[totalUsuarios] = clavaNueva;
        totalUsuarios++;
    ...
    public static double validarPago(double totalPagar) {
        if (!sesionIniciada) {
            ...
            if (opcion == 1) {
                boolean acceso = iniciarSesion(3);
                if (!acceso) {
                    System.out.println("No se pudo iniciar sesión. Compra cancelada.");
                    return 0;
                }
            }
            else if (opcion == 2) {
                registrarUsuario();
                System.out.print("¿Desea iniciar sesión ahora para continuar con la compra? (1=Sí / 0=No): ");
                ...
                if (iniciar == 1) {
                    ...
                    System.out.println("Compra cancelada. Debe iniciar sesión para comprar.");
                    return 0;
                }
            }
            else {
            ...
            sesionIniciada = true;
            System.out.println("¡Sesión iniciada exitosamente! Continuando con su compra...");
        }
        System.out.println("========================================");
        ...
        switch (metodo) {
            case 1: montoPagado = pagarEfectivo(totalPagar); break;
            case 2: montoPagado = pagarTarjeta(totalPagar); break;
            case 3: montoPagado = pagarYape(totalPagar); break;
        }
        return montoPagado;
    }
